-- Synch vectors for the assembly of <Comp3_Queue,Comp3_Body, Comp3_message(), Comp3_encrypt(key), Comp3_isActive_ac(), Comp3_left_ac(), Comp3_cnum_ac(), Comp3_max_ac(), Comp3_requestKey_Proxy_Manager(px0), Comp3_requestKey_Proxy[px0]>
...
<Comp3_Queue,Comp3_Body, Comp3_message(), Comp3_encrypt(key), Comp3_isActive_ac(), Comp3_left_ac(), Comp3_cnum_ac(), Comp3_max_ac(), Comp3_requestKey_Proxy_Manager(px0), Comp3_requestKey_Proxy[px0]>
